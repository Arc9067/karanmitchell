        ...
        <div className="km-header__inner">
          ...
          <div className="km-header__brand">
            ...
            <div className="km-header__brand-text">
              ...
              <span className="km-header__brand-sub">Application Desk</span>
            </div>
          </div>
      ...
      <main className="km-body">
        {status === "success" ? (
          <div className="km-success-card">
            ...
            <p className="km-success-desc" style={{ marginTop: "-16px", fontSize: "14px", color: "#64748b" }}>
              ...
              <form onSubmit={step === 3 ? handleSubmit : nextStep} noValidate>
                ...
                {step === 3 && (
                  <div>
                    ...
                    {status === "error" && (
                      <div style={{ color: "#dc2626", background: "#fef2f2", border: "1px solid #fecaca", padding: "12px", borderRadius: "8px", marginBottom: "16px", fontSize: "14px" }}>
